...
class FactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fact" do
    assert_difference("Fact.count") do
      post facts_url, params: { fact: { character: @fact.character, droid: @fact.droid, planet: @fact.planet, quote: @fact.quote } }
    end
  ...
  test "should update fact" do
    patch fact_url(@fact), params: { fact: { character: @fact.character, droid: @fact.droid, planet: @fact.planet, quote: @fact.quote } }
